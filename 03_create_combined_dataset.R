...
assoc = assoc %>%
  ...
  dplyr::select(Host_Harmonised, Host_Original, HostClass, HostOrder, HostFamily, Pathogen_Harmonised, Pathogen_Original, PathogenType, Database, DatabaseVersion, Year, YearType,
...
assoc$DetectionMethod_Original[ assoc$Database == "EID2" & assoc$YearType == "Nucleotide" & !is.na(assoc$YearType) ] = "PCR"
